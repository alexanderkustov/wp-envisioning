...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_style( 'flat-stylesheet', get_template_directory_uri() . '/library/css/flat.css', array(), '', 'all' );
    wp_register_style( 'font-stylesheet', get_template_directory_uri() . '/library/css/fonts.css', array(), '', 'all' );

    wp_register_style( 'custom-stylesheet', get_template_directory_uri() . '/library/css/custom.css', array(), '', 'all' );
    ...
    wp_enqueue_style( 'flat-stylesheet' );
